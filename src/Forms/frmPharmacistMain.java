 ...
 * @author hp-
 */
public class frmPharmacistMain extends javax.swing.JFrame {
    ...
    String Uname;
    String type;
    public frmPharmacistMain(int userID, String username, String type) {
        initComponents();
        this.uID = userID;
        this.Uname = username;
        this.type = type;
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(frmPharmacistMain.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new frmPharmacistMain().setVisible(true);
            }
        });
    }
